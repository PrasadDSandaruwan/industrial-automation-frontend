...
export default class RemainingIngredientAmount extends Component {
  state = {
    machines: [],
  ...
  componentDidMount = async () => {
    try {
      const response = await machineService.getAllMachinesByType('PACK')
      console.log('Remaining ingredients response data', response)
  ...
  render() {
    return (
      <div>
        <h5 className="m-0 p-0">Rate of Final Production</h5>
