        ...
        <div className="az-content-body">
          ...
          <div className="az-dashboard-nav">
            <nav className="nav">
              ...
              <NavLink  className="nav-link"  to="/machines/edit-initial-rates">Add Initial Rates</NavLink>
          ...
          <Route exact path ="/machines/edit-initial-rates" component={EditInitialRates}></Route>
          <Route exact path="/machines/edit-machine-details/:id" component={EditMachine}></Route>
        </div>
      </div>
