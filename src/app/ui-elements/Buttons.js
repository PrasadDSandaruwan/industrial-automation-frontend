        ...
        <div className="container d-flex p-md-0">
          ...
          <div className="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <table className="table az-table-reference">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    indigo | primary | secondary | success | warning | danger |
                    info | light | dark
                  </td>
                </tr>
              </tbody>
            ...
            <div className="row row-xs wd-xl-80p">
              ...
              <div className="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                <Button variant="outline-indigo btn-rounded btn-block">
                  Primary
                </Button>
              </div>
              <div className="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                <Button variant="primary btn-rounded btn-block">
                  Secondary
                </Button>
              </div>
              <div className="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                <Button variant="outline-primary btn-rounded btn-block">
                  Secondary
                </Button>
              </div>
            </div>
            ...
            <div className="row row-xs wd-xl-80p">
              <div className="col-sm-6 col-md-3">
                <Button variant="indigo btn-with-icon btn-block">
                  <i className="typcn typcn-folder"></i> Folder
                </Button>
              </div>
              <div className="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                <Button variant="primary btn-with-icon btn-block">
                  <i className="typcn typcn-mail"></i> Mail
                </Button>
              </div>
              <div className="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                <Button variant="success btn-with-icon btn-block">
                  <i className="typcn typcn-edit"></i> Edit
                </Button>
              </div>
            </div>
            ...
            <div className="row row-sm">
              ...
              <div className="col-lg-2 mg-t-20 mg-lg-t-0">
                <ButtonGroup aria-label="Basic example">
                  ...
                  <Button variant="secondary btn-icon" active>
              ...
              <div className="col-lg-4 mg-t-20 mg-lg-t-0">
                <ButtonGroup aria-label="Basic example">
                  <Button variant="indigo btn-icon" active>
                    <i className="typcn typcn-media-play-outline"></i>
                  </Button>
                  <Button variant="primary btn-icon">
                    <i className="typcn typcn-media-pause-outline"></i>
